            ...
            x-data="{
                ...
                askSave() {
                    this.confirm = {
                        open: true,
                        title: 'Save changes?',
                        message: 'This will update availability for this date.',
                ...
                askCancel() {
                    this.confirm = {
                        ...
                        message: 'You will return to the availability list and unsaved changes will be lost.',
                        onConfirm: () => window.location.href = '{{ route('admin.availability.index') }}',
                    };
                },
            }"
        >
