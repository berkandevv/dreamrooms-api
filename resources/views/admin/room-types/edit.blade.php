            ...
            x-data="{
                ...
                askSave() {
                    this.confirm = {
                        open: true,
                        title: 'Save changes?',
                        message: 'This will update the room type information.',
                ...
                askCancel() {
                    this.confirm = {
                        ...
                        message: 'You will return to the room types list and unsaved changes will be lost.',
                        onConfirm: () => window.location.href = '{{ route('admin.room-types.index') }}',
                    };
                },
            }"
        >
